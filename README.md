...
>All the commands below are runned under Ubuntu 16.04.3 LTS system, if you are in other distributions of linux, please change the command to the corresponding pattern.
...
>$source ~/.bashrc
>```
>>Also, pip is a gorgeous tool or installing Python packages. Install pip 
