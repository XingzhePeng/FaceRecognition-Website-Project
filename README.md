...
>
>>Hey, you're using the default Django server just now. To deploy in on Apache, there are way more steps to operate. I'd be really happy if you want to share your opinions to me.
